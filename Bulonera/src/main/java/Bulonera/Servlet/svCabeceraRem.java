 ...
 * @author tobi2
 */
@WebServlet(name = "svCabeceraRem", urlPatterns = {"/svCabeceraRem"})
public class svCabeceraRem extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        processRequest(request, response);
        int nroClient = Integer.parseInt(request.getParameter("NroClientCabec"));
        String nombCabec = request.getParameter("nombCabec");
        String Cuit = request.getParameter("cuitCabec");
        String fechaRem = request.getParameter("fechaCabec");
        ...
        cabec.setNro_cliente(nroClient);
        cabec.setRazon_social(nombCabec);
