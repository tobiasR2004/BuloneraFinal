            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="DNI del cliente que desea modificar" id="dniModi" aria-label="DNI" aria-describedby="button-addon2" required pattern="[0-9]+" name="buscarCl"">
